...
class App extends Container
{
    ...
    public function getPublicPath(): string
    {
        ...
        return $this->rootPath . $path . DIRECTORY_SEPARATOR;
    }
    ...
    public function initialize()
    {
        ...
        // 系统运行环境
        $this->environment = $this->runningEnvironment();
        ...
        // 判断程序运行模式
        $this->appMode = file_exists($this->config->get('flag.' . $this->environment . '.mode', '/usr/local/sbin/xmld')) ? 'npv' : 'localhost';

        // 判断是否开发模式
        $this->development = file_exists($this->config->get('flag.' . $this->environment . '.development', '/mnt/dbdb')) ? true : false;
     ...
     * @return string
     */
    public function runningEnvironment()
    {
        $os_str = "linux";
        $os_name = PHP_OS;
