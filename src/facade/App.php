 ...
 * @mixin \SeanPhp\App
 * @method static \SeanPhp\Service|null register(\SeanPhp\Service|string $service, bool $force = false) 注册服务
 * @method static mixed bootService(\SeanPhp\Service $service) 执行服务
 * @method static \SeanPhp\Service|null getService(string|\SeanPhp\Service $service) 获取服务
 * @method static \SeanPhp\App debug(bool $debug = true) 开启应用调试模式
 * @method static bool isDebug() 是否为调试模式
 * @method static \SeanPhp\App setNamespace(string $namespace) 设置应用命名空间
 * @method static string mode() 获取程序运行模式
 ...
 * @method static string getframePath() 获取核心框架目录
 ...
 * @method static \SeanPhp\App initialize() 初始化应用
