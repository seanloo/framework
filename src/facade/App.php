 ...
 * @mixin \frame\App
 * @method static \frame\Service|null register(\frame\Service|string $service, bool $force = false) 注册服务
 * @method static mixed bootService(\frame\Service $service) 执行服务
 * @method static \frame\Service|null getService(string|\frame\Service $service) 获取服务
 * @method static \frame\App debug(bool $debug = true) 开启应用调试模式
 * @method static bool isDebug() 是否为调试模式
 * @method static \frame\App setNamespace(string $namespace) 设置应用命名空间
 ...
 * @method static \frame\App initialize() 初始化应用
