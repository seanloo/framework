 ...
 * @method static \frame\Boot debug(bool $debug = true) 开启应用调试模式
 * @method static bool isDebug() 是否为调试模式
 * @method static \frame\Boot setNamespace(string $namespace) 设置应用命名空间
 ...
 * @method static \frame\Boot initialize() 初始化应用
